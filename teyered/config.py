...
POSE_COORDINATES = [
  *list(range(*JAW_COORDINATES)),
  *list(range(*NOSE_COORDINATES)),
  36, 39, 42, 45, 48, 54  # Eyes and mouth corners
]

FACE_COORDINATES_NUM = max(
  *JAW_COORDINATES, *LEFT_EYEBROW_COORDINATES, *RIGHT_EYEBROW_COORDINATES,
  *NOSE_COORDINATES, *RIGHT_EYE_COORDINATES, *LEFT_EYEBROW_COORDINATES,
  *MOUTH_COORDINATES
)
...
DIST_COEFFS = np.array([[-0.0992409, 1.0407034, -0.00665748, -0.01156595, 
-2.11200394]], dtype="double")
"""

# Approximation for any camera parameters
FOCAL_LENGTH = UNIVERSAL_RESIZE
CENTER = (UNIVERSAL_RESIZE / 2, UNIVERSAL_RESIZE * ASPECT_RATIO / 2)
CAMERA_MATRIX = np.array(
